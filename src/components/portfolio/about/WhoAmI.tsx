    ...
    >
      ...
      >
        ...
        <p className="text-gray-600 text-justify title text-lg">
          ...
          about creating{" "}
          <span className="text-black font-medium">efficient</span>,
          <span className="text-black font-medium"> scalable</span>, and
          <span className="text-black font-medium"> user-centric</span>{" "}
          solutions. My expertise spans across
          ...
          <span className="text-black font-medium">
            {" "}
            backend development using Django and the MERN stack
          </span>
          , and{" "}
          <span className="text-black font-medium">
            {" "}
          ...
          . I am constantly exploring new trends in
